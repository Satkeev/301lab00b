...
// Functions created through function declarations / expressions are both constructable
// and callable. Arrow functions (and methods) are only callable. class constructors are only constructable

// 3. Explain why "this" is different when an arrow function is used.
// An arrow function expression is a syntactically compact alternative to a regular function expression,
// although without its own bindings to the this, arguments, super, or new.target keywords. Arrow 
